...
参与 **Starship** 的编写 **需要** 一个 GitHub 账号（可以前往 [GitHub 的账号注册页面](https://github.com/signup) 页面注册），但 **不需要** 高超的 GitHub 技巧，即使你是一名新手，只要按照下面所述的步骤操作，也能够 **非常出色** 地完成编辑。
...
如果你的学校有**Starship**的文稿收集志愿者，那么你甚至可以在校园张贴栏发表你的文章。如果我们的文稿收集志愿者看到了你的文章，会收录你的文章并在文章下方留下提示。
